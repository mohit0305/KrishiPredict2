...
function RabiProfit() {
    ...
    'Uttarakhand',
    'WestBengal']
    const cropTypes = ['wheat','sugarcane','gram','masur','peas']
    const price = [2015,290,5230,5500,6000]
   ...
   var a = Rabi.filter(Rabi => {
       return Rabi.state === formData.states 
   })
...
if (click == true ) {
    ...
    return (
        <div><div>
            ...
            <CanvasJSChart options = {option1}
                ...
                ><b>Total Revenue</b></CanvasJSChart> 
    ...
    <div className="form">
        <div className="form__form_group">
            ...
            <center><div className="form__title">Revenue Estimator (Rabi season)</div></center>
...
<Button onClick={(e)=>handleClick(e)} className="form__button" color="primary" variant="contained">Estimate Revenue</Button>
        </div>
    </div>
)
}

export default RabiProfit 
