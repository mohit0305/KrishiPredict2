    ...
    if(predictionData.final_prediction) {
                    ...
                    {/* <CardActionArea> */}
                        ...
                        <TableContainer component={Paper}>
                            <Table className={classes.table} aria-label="simple table">
                                <TableHead>
                                <TableRow>
                                    <TableCell component="th" align="center"><b>Model-1 Prediction</b></TableCell>
                                    <TableCell component="th" align="center"><b>Model-2 Prediction</b></TableCell>
                                    <TableCell component="th" align="center"><b>Model-3 Prediction</b></TableCell>
                                </TableRow>
                                </TableHead>
                                <TableBody>
                                    <TableRow>
        ...
        <div className="form">
            <div className="form__form_group">
                ...
                <TextField onChange={(e) => handleChange(e)} value={formData.N} className="form__text_field" id="N" name="N" variant="filled" label="Amount of Nitrogen in Soil (mg-N/kg soil)" />
                <TextField onChange={(e) => handleChange(e)} value={formData.P} className="form__text_field" id="P" name="P" variant="filled" label="Amount of Phosphorous in Soil (ppm)" />
                <TextField onChange={(e) => handleChange(e)} value={formData.K} className="form__text_field" id="K" name="K" variant="filled" label="Amount of Pottasium in Soil (ppm)" />
                <TextField onChange={(e) => handleChange(e)} value={formData.temperature} className="form__text_field" id="temperature" name="temperature" variant="filled" label="Temperature (in Celcius < =47)" />
