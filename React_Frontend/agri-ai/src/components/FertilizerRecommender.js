...
function FertilizerRecommender() {
    ...
    const formRenderData = [
        {
           name:"Nitrogen",
           description:"Amount Of Nitrogen in Soil (mg-N/kg soil)"
        },
        {
            name:"Potassium",
            description:"Amount of Potassium in Soil (ppm)"
         },
         {
            name:"Phosphorous",
            description:"Amount of Phosphorous in Soil (ppm)"
         },
         {
            name:"Temparature",
            description:"Temperature (in Celcius < 47)"
         },
         {
            name:"Humidity",
    ...
    const handleChange = (e, changeKey=undefined) => {
        ...
        setFormData(newData)
        //console.log(formData.soil_type)
    }
    
    let index = soilTypes.indexOf(formData.soil_type);
    console.log(index);
